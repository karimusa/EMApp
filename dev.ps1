...
.DESCRIPTION
    Development-only workflow: permissions, git pull, venv, packages, setup,
    database check, stop old server, start app, open browser.
...
Usage:
  .\dev.ps1 [-SkipGitPull] [-NoBrowser] [-Port 50006]

  SkipGitPull   Do not run git pull
...
if ($SkipGitPull) {
    ...
    Write-Host '[2/9] Pulling latest code...' -ForegroundColor Yellow
